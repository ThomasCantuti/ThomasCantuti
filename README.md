...
![Uploading api.svg…]
      ...
      >
        <title id="titleId">C.D.Pisano's GitHub Stats, Rank: C</title>
        <desc id="descId">Total Stars Earned: 0, Total Commits in 2023 : 0, Total PRs: 1, Total Issues: 4, Contributed to (last year): 0</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 246.35980227785876;
      }
    }
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >C.D.Pisano's GitHub Stats</text>
    </g>
      </g>
